    ...
    <table>
      <form action="auth.php" method="post">
        ...
        <tr>
          ...
          <td><input type="text" name="email" class="form-control"  value="" placeholder="メールアドレスを入力して下さい。"></td>
        </tr>
        <tr>
          <th><label for="exampleInputPassword1" class="form-label">パスワード(半角英数字6~8文字):</label></th>
          <td><input type="password" name="password " class="form-control" value="" placeholder="パスワードを入力して下さい。"></td>
        </tr>
        <tr>
